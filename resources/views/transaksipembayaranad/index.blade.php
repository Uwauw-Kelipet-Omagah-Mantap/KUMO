                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" action="{{ route('pengguna.simpan') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="Mobil" class="form-control mb-3" placeholder="Nama Pemilik Rekening">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Tanggal Mulai</label>
                                        <input type="date" name="No Rekening" class="form-control mb-3" placeholder="No Rekening">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="role" class="form-select mb-3" >
                                            ...
                                            <option value="sedang_dalam_masa_penggunaan">Sedang dalam Masa penggunaan</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="" class="form-label">Tanggal Selesai</label>
                                        <input input type="number" min="0.00" max="1.000.000.000" step="100.000" name="Total Biaya" class="form-control mb-3" placeholder="Total Biaya">
                                    </div>
