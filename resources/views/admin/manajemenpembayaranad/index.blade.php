                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="post" action="{{ route('pengguna.simpan') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="Jenis Bank" class="form-control mb-3"
                                                placeholder="Masukkan Username" value="FALSE TRANSACTION" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">Nama Pemilik Rekening</label>
                                            <input type="text" name="Nama Pemilik Rekening" class="form-control mb-3"
                                                placeholder="Nama Pemilik Rekening">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">No Rekening</label>
                                            <input type="text" name="No Rekening" class="form-control mb-3"
                                                onkeypress="return /[0-9]/i.test(event.key)" placeholder="No Rekening">
                                        </div>
